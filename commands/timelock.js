  ...
  async execute(interaction) {
    ...
    switch (actiontotake) {
      case "chastitybelt":
        ...
        if (!chastity) {
          interaction.reply({
            content: `${wearer} is not wearing a chastity belt`,
        ...
        if (chastity.keyholder != interaction.user.id) {
          interaction.reply({
            content: `You do not have the key to ${wearer}'s chastity belt`,
            flags: MessageFlags.Ephemeral,
          });
          return;
        }
      ...
      case "chastitybra":
        ...
        if (!chastitybra) {
          interaction.reply({
            content: `${wearer} is not wearing a chastity bra`,
            flags: MessageFlags.Ephemeral,
          });
          return;
        }
        ...
        if (chastitybra.keyholder != interaction.user.id) {
          interaction.reply({
            content: `You do not have the key to ${wearer}'s chastity bra`,
            flags: MessageFlags.Ephemeral,
          });
          return;
        }
      ...
      case "collar":
        ...
        if (!collar) {
          interaction.reply({
            content: `${wearer} is not wearing a collar`,
            flags: MessageFlags.Ephemeral,
          });
          return;
        }
        ...
        if (collar.keyholder != interaction.user.id) {
          interaction.reply({
            content: `You do not have the key to ${wearer}'s collar`,
            flags: MessageFlags.Ephemeral,
          });
          return;
        }
