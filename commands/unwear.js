...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addUserOption((opt) =>
      opt.setName("user").setDescription("Who to remove fashion from?"),
    )
    .addStringOption((opt) =>
      opt
        .setName("type")
        .setDescription("What fashion to remove...")
  ...
  async autoComplete(interaction) {
    ...
    if (focusedValue == "") {
      ...
      let sorted = process.wearableslist.filter((f) =>
  ...
  async execute(interaction) {
    try {
      let wearableuser = interaction.options.getUser("user")
