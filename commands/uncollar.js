...
module.exports = {
  ...
  async execute(interaction) {
    try {
      let collaruser = interaction.options.getUser("user")
      ...
      if (getHeavy(interaction.user.id)) {
        ...
        if (interaction.user == collaruser) {
          ...
          if (getCollar(collaruser.id)) {
            ...
            data.collar = true;
            if (
              canAccessCollar(collaruser.id, interaction.user.id, true).access
            ) {
          ...
          if (getCollar(collaruser.id)) {
            ...
            if (
              ...
              data.nokey = true;
              if (
                !getCollar(collaruser.id).keyholderOnly &&
                getCollar(collaruser.id).keyholder == collaruser.id
              ) {
