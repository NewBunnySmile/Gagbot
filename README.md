...
### Consent
It is designed with a **Consent First** approach, where while most actions can be done to a given user, it is trivial to revert them using the appropriate un___ command. In order to prevent this, users have to willingly use certain commands which are called out in their description. 

### Contributions
Please feel free to suggest or submit contributions for this code. Please keep in mind while considering using this or forking it that I would like to maintain the philosophy this bot was built upon: facilitating consenting roleplay. Features that infringe upon that or are obscene will be rejected outright.
