...
const heavytypes = [
  // Armbinders
  {
    name: "Ancient Armbinder",
    value: "armbinder_ancient",
    denialCoefficient: 3.5,
  },
  { name: "Latex Armbinder", value: "armbinder_latex", denialCoefficient: 2 },
  {
    name: "Leather Armbinder",
    value: "armbinder_leather",
    denialCoefficient: 2,
  },
  {
    name: "High Security Armbinder",
    value: "armbinder_secure",
    denialCoefficient: 3.5,
  },
  {
    name: "Shadow Latex Armbinder",
    value: "armbinder_shadowlatex",
    denialCoefficient: 3,
  },
  {
    name: "Crystal Armbinder",
    value: "armbinder_crystal",
    denialCoefficient: 3,
  },
  {
    name: "Black Hole Armbinder",
    value: "armbinder_blackhole",
    denialCoefficient: 3.5,
  },
  { name: "Wolfbinder", value: "armbinder_wolf", denialCoefficient: 3 },
  {
    name: "Wolf Queenbinder",
    value: "armbinder_wolfqueen",
    denialCoefficient: 3,
  },
  ...
  {
    name: "Leather Boxbinder",
    value: "boxbinder_leather",
    denialCoefficient: 2.5,
  },
  {
    name: "High-Security Boxbinder",
    value: "boxbinder_hisec",
    denialCoefficient: 3.5,
  },
  {
    name: "Experimental Boxtie Binder",
    value: "boxbinder_experimental",
    denialCoefficient: 3.5,
  },
  {
    name: "Black Hole Boxbinder",
    value: "boxbinder_blackhole",
    denialCoefficient: 2,
  },
  {
    name: "Dragon Queen Straps",
    value: "boxbinder_dragon",
    denialCoefficient: 2.5,
  },

  // Straitjackets
  {
    name: "Comfy Straitjacket",
    value: "straitjacket_comfy",
    denialCoefficient: 3,
  },
  {
    name: "Maid Straitjacket",
    value: "straitjacket_maid",
    denialCoefficient: 3.5,
  },
  {
    name: "Maid Punishment Straitjacket",
    value: "straitjacket_maidpunishment",
    denialCoefficient: 4.5,
  },
  {
    name: "Doll Straitjacket",
    value: "straitjacket_doll",
    denialCoefficient: 3.5,
  },
  {
    name: "Shadow Latex Straitjacket",
    value: "straitjacket_shadowlatex",
    denialCoefficient: 4,
  },
  {
    name: "Asylum Straitjacket",
    value: "straitjacket_asylum",
    denialCoefficient: 5,
  },
  {
    name: "Black Hole Straitjacket",
    value: "straitjacket_blackhole",
    denialCoefficient: 4.5,
  },
  ...
  {
    name: "Alchemical Petsuit",
    value: "petsuit_latex",
    denialCoefficient: 2.5,
  },
  { name: "Autotape Petsuit", value: "petsuit_tape", denialCoefficient: 2.5 },
  {
    name: "Shadow Latex Petsuit",
    value: "petsuit_shadowlatex",
    denialCoefficient: 3,
  },
  { name: "Bast Petsuit", value: "petsuit_bast", denialCoefficient: 3 },
  {
    name: "Nevermere Punishment Suit",
    value: "petsuit_nevermere",
    denialCoefficient: 3.5,
  },
  ...
  {
    name: "Latex Encasement Stand",
    value: "encasementstand_latex",
    denialCoefficient: 4,
  },
  ...
  // Metal Restraints
  {
    ...
    value: "scavengersdaughter",
    denialCoefficient: 4,
  },
  { name: "Yoke", value: "yoke", denialCoefficient: 2 },
  {
    name: "Hardlight Cuffs (loose links)",
    value: "hardlight_looselink",
    denialCoefficient: 1.5,
  },
  {
    name: "Hardlight Cuffs (hogtie)",
    value: "hardlight_hogtie",
    denialCoefficient: 3,
  },
  {
    name: "Hardlight Cuffs (strict)",
    value: "hardlight_strict",
    denialCoefficient: 4.5,
  },
  ...
  {
    name: "Suspended Frogtie",
    value: "rope_suspension_frog",
    denialCoefficient: 3,
  },
  ...
  {
    name: "Shadow Latex Ballsuit",
    value: "shadow_latex_ball",
    denialCoefficient: 4,
  },
  ...
  // Heavy Restraints with unique name functions
  {
    ...
    namefunction: async (interaction, data) => {
      if (
        data.textarray != "texts_collarequip" &&
        data.textarray != "texts_struggle"
      ) {
        return data;
        ...
        if (data.textarray == "texts_collarequip") {
          let guilduser = await interaction.guild.members.cache.get(
            datatoreturn.textdata.interactionuser.id,
          );
