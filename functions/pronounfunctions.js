...
const convertPronounsText = (text, data) => {
  ...
  let user = {
    ...
    possessiveDeterminer: getPronouns(
      interactionuser.id,
  ...
  let isDoll = false;
  if (
    getOption(interactionuser.id, "dollforcedit") == "enabled" &&
    getHeadwear(interactionuser.id).find((headwear) =>
      DOLLVISORS.includes(headwear),
    )
  ) {
    ((user.subject = "it"),
      (user.object = "it"),
  ...
  if (
    getOption(targetuser.id, "dollforcedit") == "enabled" &&
    getHeadwear(targetuser.id).find((headwear) => DOLLVISORS.includes(headwear))
  ) {
    ((target.subject = "it"),
      (target.object = "it"),
  ...
  outtext = outtext.replaceAll(
    "USER_ISARE",
    user.subject == "they" ? "are" : "is",
  );
  // And was/were
  outtext = outtext.replaceAll(
    "USER_WERE",
    user.subject == "they" ? "were" : "was",
  );
  // And wasn't/weren't
  outtext = outtext.replaceAll(
    "USER_WERENT",
    user.subject == "they" ? "weren't" : "wasn't",
  );
  // And "doesn't"
  outtext = outtext.replaceAll(
    "USER_DOESNT",
    user.subject == "they" ? "don't" : "doesn't",
  );
  // And "es"
  ...
  outtext = outtext.replaceAll(
    "USER_TRY",
    user.subject == "they" ? "try" : "tries",
  );
  // And "have"
  outtext = outtext.replaceAll(
    "USER_HAVE",
    target.subject == "they" ? "have" : "has",
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEMSELF_CAP",
    user.reflexive.slice(0, 1).toUpperCase() + user.reflexive.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEM_CAP",
    user.object.slice(0, 1).toUpperCase() + user.object.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEIRS_CAP",
    user.possessive.slice(0, 1).toUpperCase() + user.possessive.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEIR_CAP",
    user.possessiveDeterminer.slice(0, 1).toUpperCase() +
      user.possessiveDeterminer.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEYRE_CAP",
    user.subjectIs.slice(0, 1).toUpperCase() + user.subjectIs.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEYLL_CAP",
    user.subjectWill.slice(0, 1).toUpperCase() + user.subjectWill.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "USER_THEY_CAP",
    user.subject.slice(0, 1).toUpperCase() + user.subject.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_ISARE",
    target.subject == "they" ? "are" : "is",
  );
  // And was/were
  outtext = outtext.replaceAll(
    "TARGET_WERE",
    target.subject == "they" ? "were" : "was",
  );
  // And wasn't/weren't
  outtext = outtext.replaceAll(
    "TARGET_WERENT",
    target.subject == "they" ? "weren't" : "wasn't",
  );
  // And "doesn't"
  outtext = outtext.replaceAll(
    "TARGET_DOESNT",
    target.subject == "they" ? "don't" : "doesn't",
  );
  // And "es"
  outtext = outtext.replaceAll(
    "TARGET_ES",
    target.subject == "they" ? "" : "es",
  );
  // And "s"
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEMSELF_CAP",
    target.reflexive.slice(0, 1).toUpperCase() + target.reflexive.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEM_CAP",
    target.object.slice(0, 1).toUpperCase() + target.object.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEIRS_CAP",
    target.possessive.slice(0, 1).toUpperCase() + target.possessive.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEIR_CAP",
    target.possessiveDeterminer.slice(0, 1).toUpperCase() +
      target.possessiveDeterminer.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEYRE_CAP",
    target.subjectIs.slice(0, 1).toUpperCase() + target.subjectIs.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEYLL_CAP",
    target.subjectWill.slice(0, 1).toUpperCase() + target.subjectWill.slice(1),
  );
  ...
  outtext = outtext.replaceAll(
    "TARGET_THEY_CAP",
    target.subject.slice(0, 1).toUpperCase() + target.subject.slice(1),
  );
...
exports.they = (user, capitalise = false) =>
  getPronouns(user, "subject", capitalise);
exports.them = (user, capitalise = false) =>
  getPronouns(user, "object", capitalise);
exports.theirs = (user, capitalise = false) =>
  getPronouns(user, "possessive", capitalise);
exports.their = (user, capitalise = false) =>
  getPronouns(user, "possessiveDeterminer", capitalise);
exports.themself = (user, capitalise = false) =>
  getPronouns(user, "reflexive", capitalise);
exports.theyre = (user, capitalise = false) =>
  getPronouns(user, "subjectIs", capitalise);
exports.theyll = (user, capitalise = false) =>
  getPronouns(user, "subjectWill", capitalise);
