...
let wearabletypes = [
  ...
  },
  {
    ...
    value: "wombtat",
    colorable: true,
    uniqueColors: ["Glowing", "Starry", "Shimmering", "Cyber"],
  },
  {
    name: "Vine Hair",
    value: "hair_vine",
    colorable: true,
    uniqueColors: ["Flowery", "Verdant"],
  },
  { name: "Vampire Fangs", value: "fangs_vampire" },
  {
    ...
    value: "halo",
    colorable: true,
    uniqueColors: ["Angelic", "Ghostly", "Ethereal", "Holy Light", "Cyber"],
  },
  ...
  {
    name: "Witch Hat",
    value: "witchhat_normal",
    colorable: true,
    uniqueColors: ["Flowery", "Ridiculously Big", "Starry"],
  },
  {
    name: "Crown",
    value: "crown",
  ...
  },
  {
    ...
    value: "sunglasses",
    colorable: true,
    uniqueColors: ["Mirrored", "Aviator", "Heart Shaped", "Kamina"],
  },
  {
    name: "Goggles",
    value: "goggles",
    colorable: true,
    uniqueColors: ["Steampunk", "Alchemist", "Ski", "Lab"],
  },
  ...
  },
  {
    ...
    value: "veil",
    colorable: true,
    uniqueColors: ["Stary", "Sheer", "Silk", "Half-Face"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  },
  {
    ...
    value: "hood",
    colorable: true,
    uniqueColors: ["Leather", "Latex", "Maid", "Hardlight", "Medieval"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  { name: "Domino Mask", value: "mask_domino" },
  {
    ...
    value: "eyeshadow",
    colorable: true,
    uniqueColors: ["Glittery", "Metallic Silver", "Metallic Gold"],
  },
  {
    name: "Lipstick",
    value: "lipstick",
    colorable: true,
    uniqueColors: ["Glossy", "Metallic Silver", "Metallic Gold"],
  },
  {
    name: "Kissmark",
    value: "kissmark",
  ...
  {
    name: "Leather Bunny Bustier",
    value: "bunnybustier_leather",
    colorable: true,
  },
  {
    name: "Latex Bunny Bustier",
    value: "bunnybustier_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  { name: "Bunny Tights", value: "bunnytights", colorable: true },
  {
    name: "Latex Bunny Tights",
    value: "bunnytights_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  { name: "Bunny Shoes", value: "bunnybustier", colorable: true },
  {
    name: "Latex Bunny Shoes",
    value: "bunnybustier_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  },
  {
    ...
    value: "maiddress_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow", "Gothic", "French", "Cyber"],
  },
  {
    name: "Apron",
    value: "maid_apron",
  ...
  {
    name: "Maid Badge of Office",
    value: "maid_badge",
    colorable: true,
    uniqueColors: ["Brass", "Silver", "Gold"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  {
    name: "Latex Drone Suit",
    value: "dronesuit_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  {
    name: "Harness",
    value: "harness_leather",
    colorable: true,
    uniqueColors: ["Vine", "Leather", "Latex", "Leather", "Rubber", "Shibari"],
  },
  {
    name: "Bondage Wrist Cuffs",
    value: "cuffswrist_bondage",
    colorable: true,
    uniqueColors: [
      "Hardlight",
      "Steel",
  ...
  {
    name: "Latex Wrist Cuffs",
    value: "cuffswrist_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  {
    name: "Bondage Ankle Cuffs",
    value: "cuffsankle_bondage",
    colorable: true,
    uniqueColors: [
      "Hardlight",
      "Steel",
  ...
  {
    name: "Latex Ankle Cuffs",
    value: "cuffsankle_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  {
    name: "Bondage Thigh Cuffs",
    value: "cuffsthigh_bondage",
    colorable: true,
    uniqueColors: [
      "Hardlight",
      "Steel",
  ...
  {
    name: "Leather Paddle",
    value: "paddle_leather",
    colorable: true,
    uniqueColors: ["Studded"],
  },
  {
    name: "Leash",
    value: "leash",
    colorable: true,
    uniqueColors: ["Hardlight", "Leather", "Rubber", "Magic"],
  },
  {
    name: "Nipple Clamps",
    value: "nippleclamps",
    colorable: true,
    uniqueColors: ["Hardlight", "Leather", "Rubber", "Magic", "Crystal"],
  },
  {
    name: "Wingbinders",
    value: "wingbinders",
  ...
  },
  {
    ...
    value: "bikini_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow", "Cow Print"],
  },
  {
    name: "Armour",
    value: "armour",
  ...
  { name: "Harem Silks", value: "haremsilks", colorable: true },
  {
    ...
    value: "outfit_magicalgirl",
    colorable: true,
  },
  {
    name: "Latex Magical Girl Uniform",
    value: "outfit_magicalgirl_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  },
  {
    ...
    value: "hoodie_eared",
    colorable: true,
    uniqueColors: ["Fox", "Cat", "Dog", "Wolf", "Bunny"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  { name: "Checked Shirt", value: "shirt_checked", colorable: true },
  {
    ...
    value: "buttonup_blouse",
    colorable: true,
    uniqueColors: ["Witchy", "Latex"],
  },
  {
    name: "Comfortable Jacket",
    value: "jacket_comfortable",
    colorable: true,
    uniqueColors: ["Leather", "Bomber", "Double-breasted"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  // Lower Body
  {
    ...
    value: "pleated_skirt",
    colorable: true,
    uniqueColors: ["Latex", "Witchy", "Gothic", "Starry", "Shadow"],
  },
  {
    name: "Miniskirt",
    value: "mini_skirt",
    colorable: true,
    uniqueColors: ["Latex", "Witchy", "Gothic", "Cheerleader"],
  },
  {
    name: "Pencil Skirt",
    value: "pencil_skirt",
  ...
  {
    name: "Leather Booty Shorts",
    value: "bootyshorts_leather",
    colorable: true,
  },
  {
    name: "Latex Booty Shorts",
    value: "bootyshorts_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow", "Leapord Print"],
  },
  ...
  { name: "Leather Dress", value: "dress_leather", colorable: true },
  {
    ...
    value: "dress_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow", "Witchy"],
  },
  ...
  { name: "Little Black Dress", value: "littleblack_dress", colorable: false },
  {
    ...
    value: "flowy_dress",
    colorable: true,
    uniqueColors: ["Gothic", "Floral"],
  },
  {
    name: "Latex Flowy Dress",
    value: "flowy_dress_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
    name: "Evening Dress",
    value: "evening_dress",
    colorable: true,
    uniqueColors: ["Gothic", "Golden", "Silver"],
  },
  {
    name: "Latex Evening Dress",
    value: "evening_dress_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
  ...
  {
    name: "Latex Minidress",
    value: "mini_dress_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
  ...
  {
    name: "Latex Chinese Dress",
    value: "chinese_dress_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
    name: "Shrine Maiden's Robe",
    value: "shrine_maiden",
    colorable: true,
    uniqueColors: ["Gothic"],
  },
  {
    name: "Latex Shrine Maiden's Robe",
    value: "shrine_maiden_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
    ...
    value: "binding_dress",
    colorable: true,
    uniqueColors: ["Latex", "Leather"],
  },
  { name: "Sweater Dress", value: "sweater_dress", colorable: true },
  {
    name: "Backless Sweater Dress",
    value: "sweater_dress_backless",
    colorable: true,
  },
  ...
  {
    name: "Royal Icing Lingerie",
    value: "lingerie_royalicing",
    colorable: false,
  },
  ...
  { name: "Nipple Pasties", value: "nipple_pasties", colorable: true },
  {
    ...
    value: "stockings",
    colorable: true,
    uniqueColors: ["Checked"],
  },
  { name: "Pantyhose", value: "pantyhose", colorable: true },
  {
    name: "Latex Stockings",
    value: "stockings_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  {
    name: "Latex Pantyhose",
    value: "pantyhose_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  {
    name: "Latex Garter Belt",
    value: "gartersbelt_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  {
    name: "Latex Thigh Band",
    value: "thighband_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  { name: "Thighhighs", value: "thighhighs", colorable: true },
  {
    ...
    value: "thighhighs_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow", "Cowprint"],
  },
  ...
  {
    name: "Latex High Waist Leotard",
    value: "leotard_highwaist_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  {
    name: "Latex High Heels",
    value: "highheels_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  { name: "Ballet Heels", value: "balletheels", colorable: true },
  {
    name: "Latex Ballet Heels",
    value: "balletheels_latex",
    colorable: true,
    uniqueColors: ["Starry", "Shadow"],
  },
  ...
  { name: "Pumps", value: "pumps", colorable: true },
  {
    ...
    value: "anklets",
    colorable: true,
    uniqueColors: ["Silver", "Gold", "Platinum", "Cobalt", "Black"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  },
  {
    ...
    value: "greaves",
    colorable: true,
    uniqueColors: ["Steel", "Cobalt", "Black"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  {
    name: "Leather Opera Gloves",
    value: "gloves_opera_leather",
    colorable: true,
    uniqueColors: ["Gothic"],
  },
  {
    name: "Latex Opera Gloves",
    value: "gloves_opera_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
    name: "Leather Gloves",
    value: "gloves_leather",
    colorable: true,
    uniqueColors: ["Gothic"],
  },
  ...
  {
    name: "Fingerless Elbow Gloves",
    value: "gloves_fingerlesselbow",
    colorable: true,
  },
  {
    name: "Latex Gloves",
  ...
  },
  {
    ...
    value: "sleeves_detatched",
    colorable: true,
    uniqueColors: ["Gothic"],
  },
  {
    name: "Detached Latex Sleeves",
    value: "sleeves_detached_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
    name: "Long Detached Sleeves",
    value: "sleeves_longdetatched",
    colorable: true,
    uniqueColors: ["Gothic"],
  },
  {
    name: "Long Detached Latex Sleeves",
    value: "sleeves_longdetached_latex",
    colorable: true,
    uniqueColors: ["Gothic", "Starry", "Shadow"],
  },
  {
    name: "Fingernail Polish",
    value: "polish_fingernails",
    colorable: true,
    uniqueColors: [
      "Iridescent",
      "Sparkly",
  ...
  {
    name: "Bridal Wristlets",
    value: "wristlets_bridal",
    colorable: true,
    uniqueColors: ["Gothic"],
  },
  {
    ...
    value: "choker",
    colorable: true,
    uniqueColors: ["Silver", "Gold", "Platinum", "Cobalt", "Gothic", "Tattoo"],
    forbiddenColors: [
      "Black",
      "Red",
      "Purple",
  ...
  { name: "Leather Choker", value: "choker_leather", colorable: true },
  {
    ...
    value: "cloak",
    colorable: true,
    uniqueColors: ["Witch", "Rogue", "Vampire", "Hooded", "Elven"],
  },
  {
    name: "Latex Cloak",
    value: "cloak_latex",
    colorable: true,
    uniqueColors: ["Witch", "Rogue", "Vampire", "Hooded"],
  },
...
const loadWearables = () => {
  ...
  console.log(
    `Wearables list is ${process.wearableslist.length} entries long.`,
  );
};
...
const getWearable = (userID) => {
  ...
  return process.wearable[userID]?.wornwearable
    ? process.wearable[userID]?.wornwearable
    : [];
};
...
const getLockedWearable = (userID) => {
  ...
  return process.wearable[userID]?.locked
    ? process.wearable[userID]?.locked
    : [];
};
  ...
  if (process.wearable[userID]) {
    if (process.wearable[userID].locked == undefined) {
      ...
      if (process.wearable[userID].locked.includes(wearable)) {
        process.wearable[userID].locked.splice(
          process.wearable[userID].locked.indexOf(wearable),
          1,
        );
      }
...
const deleteWearable = (userID, wearable) => {
  ...
  if (
    wearable &&
    process.wearable[userID].wornwearable.includes(wearable) &&
    !getLockedWearable(userID).includes(wearable)
  ) {
    process.wearable[userID].wornwearable.splice(
      process.wearable[userID].wornwearable.indexOf(wearable),
      1,
    );
...
const getWearableName = (userID, wearablename) => {
  ...
  for (let i = 0; i < process.wearableslist.length; i++) {
    convertmittenarr[process.wearableslist[i].value] =
      process.wearableslist[i].name;
  }
  if (wearablename) {
